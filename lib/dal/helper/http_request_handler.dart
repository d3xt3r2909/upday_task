...
class AppHttpRequestHandler {
  ...
  Future<HttpResponseWrapper> getHttp(
    ...
    try {
      ...
      const String consumerKey = '5af67-e0db5-44eb6-abf2e-3171a-94137';
      const String consumerClient = '95ecb-1651e-c7698-3e36e-3c935-6361d';
      const String authToken = '$consumerKey:$consumerClient';
